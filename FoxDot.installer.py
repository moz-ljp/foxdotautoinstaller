...
def after():
    ...
    mygithub = input("Would you like to visit my github? (y/n): ")
...
if(platform.system() == "Windows"):
    ...
    if(foxInstalled == True):
        ...
        if(os.path.exists("C:/Program Files/Git") == True):
    ...
    if(gitInstalled == True):
        try:
            if(os.path.exists("C:\Program Files\SuperCollider-3.10.2") == True):
            ...
            with open("startup.scd", "w") as file:
                file.write('Quarks.install("FoxDot")')
            try:
            ...
            os.system("start scide.exe")
            time.sleep(15)
            os.system("TASKKILL /F /IM scide.exe")
